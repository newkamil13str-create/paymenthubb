...
export async function POST(request: NextRequest) {
  try {
    ...
    console.log('[Kamil] Cancel deposit request:', validated.id)
    ...
    if (!transactionData || !transactionData.id) {
      console.log('[Kamil] Transaction not found:', validated.id)
    ...
    console.log('[Kamil] Current transaction status:', transactionData.status)
    ...
    console.log(`[Kamil] ${transactionData.gateway || currentGateway} cancel response:`, {
    ...
    if (!cancelResponse.status && !alreadyCanceled) {
      console.error('[Kamil] Cancel deposit failed:', cancelResponse.message)
      return NextResponse.json(
        {
    ...
    console.log('[Kamil] Deposit cancelled successfully')
    ...
    console.error('[Kamil] Cancel deposit error:', error)
