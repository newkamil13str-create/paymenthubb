...
export async function GET(request: NextRequest) {
  ...
  console.log('[Kamil] Atlantic API Diagnostics:', diagnostics)
  ...
  try {
    ...
    console.log('[Kamil] Testing Atlantic API connection...')
    ...
    console.log('[Kamil] Atlantic API test result:', testResult)
    ...
    console.error('[Kamil] Atlantic API test error:', error)
