...
export const siteConfig = {
  name: 'PaymentHub',
  businessName: 'Yilzi Digital',
  domain: process.env.NEXT_PUBLIC_DOMAIN || 'paymenthub.yilzicode.com',
  url: process.env.NEXT_PUBLIC_URL || 'https://paymenthub.yilzicode.com',
  description:
  ...
  business: {
    ...
    email: 'business@yilzicode.com',
    phone: '+6281359123789',
  },

  // Contact Information  
  contact: {
    email: 'support@yilzicode.com',
    phone: '+6281359123789',
  ...
  social: {
    ...
    github: 'YilziiHCT',
    tiktok: 'Yilziii',
    whatsapp: 'https://wa.me/6281359123789',
    email: 'mailto:owner@yilziii.com',
  },

  // External Links
  links: {
    github: 'https://github.com/YilziiHCT',
    telegram: 'https://t.me/Yilziii',
    tiktok: 'https://tiktok.com/@Yilziii',
    whatsapp: 'https://wa.me/6281359123789',
    email: 'mailto:owner@yilziii.com',
  },
